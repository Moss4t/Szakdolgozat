...
%%%%%%%%A FENTI SUBSECTION CIM NEM JÓ! javítva
\begin{definicio}
...
\begin{megjegyzes}
	Ez a definició feltételezi, hogy az irányított gráf csomópontjai atomi formulák, vagy minden csomóponot egy különbőző atommal címkéztünk fel.
\end{megjegyzes}
...
A program további részében egy másik függvényben megjelennek a fájlba íráskor a fekete és a fehér klózok:
	...
	%%%%%%%%%IDE KELLENÉNEK $ jelek, hogy szebb legyen: (kész az egész dokumentumban)
...
\chapter{Szoftver}
	...
	A program egy részének lefordítása futási problémákba ütközött, nem produkálta a teljes működést. Ennek a kijavítása ugyan fontos lépés a modellek pontos működéséhez. A kód megfelelő beállítása és finomhangolása rendkívül összetett folyamat, mivel \az{\cite{github-py08}} kód egy korábbi, Python 2.0 verzióban készülhetett, ezért kompatibilitás hiánya miatt hibára futott az újabb Python 3.0 feletti verzióban.
...
\begin{thebibliography}{2}
	...
	\bibitem{git-issue-for-examples}Az általam elindított példákra való kérés GitHub-on itt található:
	...
	\bibitem{git-issue-for-offset}Az általam elindított plussz paraméter témájú beszélgetés GitHub-on itt található:
	\\\url{https://github.com/networkx/networkx/discussions/5570}%, amiből kiindult az issue:
	%\\\url{tobecontinued}
